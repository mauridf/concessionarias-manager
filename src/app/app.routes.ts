...
import { VendedoresListComponent } from './pages/vendedores/vendedores-list.component';
import { MecanicosListComponent } from './pages/mecanicos/mecanicos-list.component';
...
export const routes: Routes = [
  ...
  { path: 'vendedores', component: VendedoresListComponent, canActivate: [AuthGuard]},
  { path: 'mecanicos', component: MecanicosListComponent, canActivate: [AuthGuard]},
